 ...
 mysql_query($insert01) or die ("error insert");
    ...
    public function readUsuarioG(){
       ...
       $sql01="select * from usuario ";
        ...
        echo"<tr><th colspan=5 align=center><strong><center>Lista de usuarios</center></strong></th></tr>";
        echo"<tr><th>CLAVE</th><th>NOMBRE</th><th>APELLIDO PATERNO</th><th>APELLIDO MATERNO</th>";
