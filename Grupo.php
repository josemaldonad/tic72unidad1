...
WHERE ag.idalumno=u.Id AND ag.idgrupo=gru.idgrupo ORDER BY gru.grupo ";
        ...
        echo"<tr><th>CLAVE</th><th>NOMBRE</th><th>APELLIDO PATERNO</th><th>APELLIDO MATERNO</th><th>GRUPO</th>";
    ...
    public function desasignar($idalumno)
    {

        $sql07= "delete from alumno_grupo where idalumno=$idalumno";
        $result07=mysql_query($sql07) or die ("error en $sql07");
        //$sql09= "update usuario set Nivel=3 where idalumno='$idalumno'";
        //$result09=mysql_query($sql09) or die ("error en $sql09");
//echo"$sql04  sql04";
    }
